    ...
    if (canvas.self.getContext) {
      ...
      d.onload = function () {
        ...
        Particles.prototype._calculate({
          color: c.fillStyle || "rgba(0,0,0,1)",
        ...
        if (l[f - 1].duration + l[f - 1].interval < l[f - 1].currTime / 2) {
          ...
          anime({
            ...
            complete: function (anim) {
              document.getElementById("load").removeChild(document.getElementById("loadCanvas"))
              window.loadingAn = false;
            }
          })
          anime({
            targets: '#loadMain',
