...
iSlider.prototype._animateFuncs = {
  ...
  'depth': function (dom, axis, scale, i, offset) {
    var rotateDirect = (axis == "X") ? "Y" : "X";
    var zoomScale = (4 - Math.abs(i - 1)) * 0.15 * 1.5;
    ...
    dom.style.webkitTransform = 'scale(' + zoomScale + ', ' + zoomScale + ') translateZ(0) translate' + axis + '(' + (offset + 1.3 * scale * (i - 1) * 0.8) + 'px)';
  },
...
//enable autoplay
iSlider.prototype.play = function (n) {
  var self = this;
